...
if (isset($_GET['search']) && !empty($_GET['search'])) {
  ...
  $search_condition .= "WHERE (c.course_code LIKE '%$search_term%' OR c.course_title LIKE '%$search_term%' OR d.dept_name LIKE '%$search_term%')";
}

if (isset($_GET['department']) && !empty($_GET['department'])) {
  $dept_id = $conn->real_escape_string($_GET['department']);
  $search_condition .= $search_condition ? " AND c.dept_id = '$dept_id'" : "WHERE c.dept_id = '$dept_id'";
}
