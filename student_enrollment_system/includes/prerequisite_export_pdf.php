...
<body>
    ...
    <div class="summary-info">
        ...
        Total Prerequisites: <?php echo $prerequisites->num_rows; ?><br>
        ...
        echo 'Unique Courses with Prerequisites: ' . ($unique_courses['unique_courses'] ?? 0);
        ?>
    </div>
    ...
    <?php 
        ...
        if ($row_count % $rows_per_page == 0 || $row_count == $total_prerequisites) {
            ...
            echo '<p><strong>Page ' . $current_page . ' of ' . $total_pages . ' - Total Prerequisites: ' . $total_prerequisites . '</strong></p>';
            echo '<p>Official Document - Polytechnic University of the Philippines Taguig Campus</p>';
            echo '<p>Course Prerequisite Management System | ' . date('F j, Y') . '</p>';
            echo '</div>';
        }
    endwhile; 
    ?>
