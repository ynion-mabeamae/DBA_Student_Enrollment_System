...
<body>
    ...
    <div class="university-header">
        ...
        <div class="report-title">DEPARTMENT MASTER LIST</div>
    ...
    <div class="summary-info">
        ...
        Total Departments: <?php echo $departments->num_rows; ?><br>
        Total Pages: <?php echo $total_pages; ?><br>
    </div>

    <div style="text-align: center;" class="no-print">
        <button class="print-btn" onclick="window.print()">🖨️ Print as PDF</button>
        <button class="print-btn" onclick="window.history.back()" style="background: #6c757d;">← Back to Departments</button>
    </div>
    ...
    <tr>
        ...
        <td><strong class="dept-code"><?php echo htmlspecialchars($department['dept_code']); ?></strong></td>
    ...
    <?php 
        ...
        if ($row_count % $rows_per_page == 0 || $row_count == $total_departments) {
            echo '</tbody></table>';
            
            // Add footer for each page
            echo '<div class="footer">';
            echo '<p><strong>Page ' . $current_page . ' of ' . $total_pages . ' - Total Departments: ' . $total_departments . '</strong></p>';
            echo '<p>Official Document - Polytechnic University of the Philippines Taguig Campus</p>';
            echo '<p>Department Management System | ' . date('F j, Y') . '</p>';
            echo '</div>';
        }
    endwhile; 
    ?>
